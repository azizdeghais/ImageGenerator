    ...
    <div className='rounded-xl group relative shadow-card
     hover:shadow-cardhover card'>
      ...
      <div className='group-hover:flex flex-col max-h-[94.5%] hidden
       absolute bottom-0 left-0 right-0 m-2 p-4 rounded-md bg-[#10131f]'>
           ...
           <div className='mt-5 flex justify-between items-center gap-2'>
              ...
              className='outline-none
               bg-transparent border-none'><img src={download} 
              alt="download" className='h-6 w-6 object-contain invert'/></button>
           </div>
      </div>
    </div>
  )
